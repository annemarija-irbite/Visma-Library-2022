...
namespace Visma_Library_2022.Controllers
{
    public class ReservationsController : Controller
    {
        ...
        {
            //var applicationDbContext = _context.Reservation.Include(r => r.ApplicationUser).Include(r => r.Book);
        ...
        public async Task<IActionResult> Create([Bind("Id,Email,BookId,DateTo")] Reservation reservation)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Email,BookId,DateTo")] Reservation reservation)
        {
